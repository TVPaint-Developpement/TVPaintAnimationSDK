...
nSDK::tErrorCode
cFadeWindow::EventWindowOpen( const nSDK::cPixelRectangle&  iArea )
{
    char  tmp[512];
    ...
    TV2ButtonTextFieldAdd( kID_Factor, {kSize_PositionX, y, kSize_TextFieldW, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, tmp );  // Text button
    ...
    // preview button
    mPreview = new  nSDK::cTV2ButtonCheckBox( this, kID_Preview, {kSize_RequesterW-20-9, y, 0, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, TV2GetLocaleString( 10011, "Preview"s ), mPlugin->NeedPreview(), [this]( int, bool  iState ){ mPlugin->SetPreview( iState ); } );
    ...
    // apply button
    mApply = new  nSDK::cTV2ButtonAction( this, kID_Apply, {9, y, kSize_RequesterW-19, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, TV2GetLocaleString( 10012, "Apply"s ), [this](int){ mPlugin->Apply(); } );
...
nSDK::tErrorCode
cFadeWindow::EventWindowClose( const nSDK::cPixelRectangle&  iArea, bool  iFinal )
{
...
nSDK::tErrorCode
cFadeWindow::EventButtonUp( int  iButtonID, const nSDK::cPixelPosition&  iPosition, int  iMouseButton, int  iPressure, int  iTimeMS, bool  iCtrlKey, double  iFX,  double  iFY )
{
    switch( iButtonID )
    {
...
void
cFadePlugin::UpdateKeyViews( nSDK::cPI2Keys*  iKeys, int  iID )
{
...
cFadePlugin::CreateRequester()
{
    ...
    mWindow = nSDK::cTV2Window::TV2OpenFilterWindow( this, new  cFadeWindow( this ), {kSize_RequesterW, kSize_RequesterH}, bPIRequesterFlags_Standard, 0 );
...
nSDK::tErrorCode
cFadePlugin::MetaEventPreview( const nSDK::cPixelRectangle&  iArea, int  iMouseButton, bool  iCtrlKey )
{
