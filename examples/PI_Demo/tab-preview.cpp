...
private:
    ...
    nSDK::cTV2RadioGroup  mPreviewMode;

    nSDK::cTV2ButtonLabel*    mGUITopLabel      {nullptr};

    nSDK::cTV2ButtonRadio*    mGUIFullScreen    {nullptr};
    nSDK::cTV2ButtonRadio*    mGUIIconic        {nullptr};

    nSDK::cTV2ButtonLabel*    mGUIPreviewLabel  {nullptr};
    nSDK::cTV2ButtonPreview*  mGUIPreview       {nullptr};
};
...
void
cTabPreview::Show( nSDK::cTV2Window*  iWindow, const nSDK::cPixelRectangle&  iArea )
{
    ...
    mGUITopLabel = new  nSDK::cTV2ButtonLabel( mWindow, id++, {0, y, 360, 20, nSDK::cPixelRectangle::eXYWH::kXYWH}, "Preview"s ); y += 20;

    x = 100;
    y = starty + 25;
    mGUIFullScreen = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "Full Screen"s, kFullScreen, &mPreviewMode );  y += 20;
    mGUIIconic     = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "Iconic"s,      kIconic,     &mPreviewMode );  y += 20;


    mGUIPreviewLabel = new  nSDK::cTV2ButtonLabel( mWindow, id++, {kTheButtonX, kTheButtonY-30, 150, 20, nSDK::cPixelRectangle::eXYWH::kXYWH}, "What you get ..."s ); y += 20;
    mGUIPreview = new  nSDK::cTV2ButtonPreview( mWindow, id++, {kTheButtonX, kTheButtonY, kTheButtonSize, kTheButtonSize, nSDK::cPixelRectangle::eXYWH::kXYWH}, kTheButtonSize );
