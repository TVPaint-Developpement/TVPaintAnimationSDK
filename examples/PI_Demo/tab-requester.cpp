...
///@{
    ...
    virtual  nSDK2::tErrorCode  EventWindowDragged( const nSDK2::cPixelPosition&  iPosition, bool  iDropped )  override;
    virtual  nSDK2::tErrorCode  EventWindowResizing( const nSDK2::cPixelRectangle&  iArea )  override;
    virtual  nSDK2::tErrorCode  EventWindowResized( const nSDK2::cPixelRectangle&  iArea )  override;
///@}
...
public:
    ...
    nSDK2::tErrorCode  TestWindowDragged( const nSDK2::cPixelPosition&  iPosition, bool  iDropped );
    nSDK2::tErrorCode  TestWindowResizing( const nSDK2::cPixelRectangle&  iArea );
    nSDK2::tErrorCode  TestWindowResized( const nSDK2::cPixelRectangle&  iArea );
    PIFlags  Flags() const;
    void  UpdateWindow();
...
private:
    ...
    nSDK2::cTV2ButtonCheckBox*  mGUILock     {nullptr};  bool  mLock     {false};
    nSDK2::cTV2ButtonCheckBox*  mGUINoDrag   {nullptr};  bool  mNoDrag   {false};
    nSDK2::cTV2ButtonCheckBox*  mGUINoDepth  {nullptr};  bool  mNoDepth  {false};
    nSDK2::cTV2ButtonCheckBox*  mGUINoClose  {nullptr};  bool  mNoClose  {false};
    nSDK2::cTV2ButtonCheckBox*  mGUICenter   {nullptr};  bool  mCenter   {false};
    nSDK2::cTV2ButtonCheckBox*  mGUIResize   {nullptr};  bool  mResize   {false};

    nSDK2::cTV2ButtonTextInteger*  mGUIX  {nullptr};  int  mX  {50};
    nSDK2::cTV2ButtonTextInteger*  mGUIY  {nullptr};  int  mY  {50};
    nSDK2::cTV2ButtonTextInteger*  mGUIW  {nullptr};  int  mW  {100};
    nSDK2::cTV2ButtonTextInteger*  mGUIH  {nullptr};  int  mH  {100};

    nSDK2::cTV2Window*  mTheWindow  {nullptr};
...
nSDK2::tErrorCode
cTestWindow::EventWindowOpen( const nSDK2::cPixelRectangle&  iArea )
{
    TV2Title( TV2GetLocaleString( 10001, "Demo"s ) );

    new  nSDK2::cTV2ButtonAction( this, 1000, {5, 5, 40, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "Close"s, [this](int){ TV2CloseWindow(); } );
...
nSDK2::tErrorCode
cTestWindow::EventWindowClose( const nSDK2::cPixelRectangle&  iArea, bool  iFinal )
{
    return  nSDK2::kErrorCode_NoError;
}
...
nSDK2::tErrorCode
cTestWindow::EventWindowDragged( const nSDK2::cPixelPosition&  iPosition, bool  iDropped )
{
...
nSDK2::tErrorCode
cTestWindow::EventWindowResizing( const nSDK2::cPixelRectangle&  iArea )
{
...
nSDK2::tErrorCode
cTestWindow::EventWindowResized( const nSDK2::cPixelRectangle&  iArea )
{
...
void
cTabWindow::Show( nSDK2::cTV2Window*  iWindow, const nSDK2::cPixelRectangle&  iArea )
{
    ...
    mGUITopLabel = new  nSDK2::cTV2ButtonLabel( mWindow, id++, {0, y, 360, 20, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "ePIRequesterFlags"s ); y += 20;

    x = 100;
    y = starty + 25;

    mGUILock    = new  nSDK2::cTV2ButtonCheckBox( mWindow, id++, {x, y, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "*_Lock"s,    &mLock,    [this](int,bool){ UpdateWindow(); } ); y += 20;
    mGUINoDrag  = new  nSDK2::cTV2ButtonCheckBox( mWindow, id++, {x, y, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "*_NoDrag"s,  &mNoDrag,  [this](int,bool){ UpdateWindow(); } ); y += 20;
    mGUINoDepth = new  nSDK2::cTV2ButtonCheckBox( mWindow, id++, {x, y, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "*_NoDepth"s, &mNoDepth, [this](int,bool){ UpdateWindow(); } ); y += 20;
    mGUINoClose = new  nSDK2::cTV2ButtonCheckBox( mWindow, id++, {x, y, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "*_NoClose"s, &mNoClose, [this](int,bool){ UpdateWindow(); } ); y += 20;
    mGUICenter  = new  nSDK2::cTV2ButtonCheckBox( mWindow, id++, {x, y, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "*_Center"s,  &mCenter,  [this](int,bool){ UpdateWindow(); } ); y += 20;
    mGUIResize  = new  nSDK2::cTV2ButtonCheckBox( mWindow, id++, {x, y, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "*_Resize"s,  &mResize,  [this](int,bool){ UpdateWindow(); } ); y += 20;

    x = 200;
    y = starty + 25;

    mGUIX = new  nSDK2::cTV2ButtonTextInteger( mWindow, id++, {x, y, 40, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "X"s, &mX, 20, 800 );  y += 20;
    mGUIY = new  nSDK2::cTV2ButtonTextInteger( mWindow, id++, {x, y, 40, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "Y"s, &mY, 20, 800 );  y += 20;
    mGUIW = new  nSDK2::cTV2ButtonTextInteger( mWindow, id++, {x, y, 40, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "W"s, &mW, 50, 400 );  y += 20;
    mGUIH = new  nSDK2::cTV2ButtonTextInteger( mWindow, id++, {x, y, 40, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "H"s, &mH, 30, 400 );  y += 20;
    ...
    mTheWindow = mTheWindow->TV2OpenWindow( demoplugin, mTheWindow, {mX, mY, mW, mH, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "Demo"s, Flags() );
...
nSDK2::tErrorCode
cTabWindow::TestWindowDragged( const nSDK2::cPixelPosition&  iPosition, bool  iDropped )
{
    char  tmp[256];
    ...
    if( mX != iPosition.X()  ||  mY != iPosition.Y() )
    {
        ...
        WriteConsole( tmp );
        mTheWindow->Area( {mX, mY, mW, mH, nSDK2::cPixelRectangle::eXYWH::kXYWH} );
    }
...
nSDK2::tErrorCode
cTabWindow::TestWindowResizing( const nSDK2::cPixelRectangle&  iArea )
{
    char  tmp[256];
...
nSDK2::tErrorCode
cTabWindow::TestWindowResized( const nSDK2::cPixelRectangle&  iArea )
{
    char  tmp[256];
