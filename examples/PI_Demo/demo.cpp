...
extern  nSDK2::cTV2Tab*  NewTabButton( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabText( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabPopup( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabSlider( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabMeta( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabWindow( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabProject( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabGeorge( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabMisc( cDemoWindow*  iWindow );
extern  nSDK2::cTV2Tab*  NewTabPreview( cDemoWindow*  iWindow );
...
nSDK2::tErrorCode
cDemoWindow::EventWindowOpen( const nSDK2::cPixelRectangle&  iArea )
{
...
printf("  new  nSDK2::cTV2ButtonTabs()\n");//DEBUG:
    mTabs = new  nSDK2::cTV2ButtonTabs( this, kID_Tabs, {9, y, kSize_RequesterW-20-9, 20, nSDK2::cPixelRectangle::eXYWH::kXYWH}, tabs, 0 );
//    TV2ButtonTabsAdd( kID_Tabs, {9, y, kSize_RequesterW-20-9, 20, nSDK2::cPixelRectangle::eXYWH::kXYWH}, tabNames, 0 );
    y += 21;
printf("  new  nSDK2::cTV2ButtonHSeparator(1)\n");//DEBUG:
    ...
    y += 2;
printf("  new  nSDK2::cTV2ButtonHSeparator(2)\n");//DEBUG:
    mSeparator2 = new  nSDK2::cTV2ButtonHSeparator( this, kID_Separator2, {0, y, kSize_RequesterW, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH} );
    y += 8;

printf("  new  nSDK2::cTV2ButtonConsoleOut()\n");//DEBUG:
    mConsoleOut = new  nSDK2::cTV2ButtonConsoleOut( this, kID_Messages, {9, y, kSize_MessagesW, kSize_MessagesH, nSDK2::cPixelRectangle::eXYWH::kXYWH} );
...
nSDK2::tErrorCode
cDemoWindow::EventWindowClose( const nSDK2::cPixelRectangle&  iArea, bool  iFinal )
{
...
nSDK2::tErrorCode
cDemoWindow::EventButtonUp( int  iButtonID, const nSDK2::cPixelPosition&  iPosition, int  iMouseButton, int  iPressure, int  iTimeMS, bool  iCtrlKey, double  iFX,  double  iFY )
{
    return  nSDK2::kErrorCode_NoError;
}
...
void
cDemoPlugin::UpdateKeyViews( nSDK2::cPI2Keys*  iKeys, int  iID )
{
...
printf("cDemoPlugin::CreateRequester()\n");//DEBUG:
    ...
    mWindow = nSDK2::cTV2Window::TV2OpenFilterWindow( this, new  cDemoWindow( this ), {kSize_RequesterW, kSize_RequesterH}, bPIRequesterFlags_Standard, 0 );
...
nSDK2::tErrorCode
cDemoPlugin::MetaEventPreview( const nSDK2::cPixelRectangle&  iArea, int  iMouseButton, bool  iCtrlKey )
{
