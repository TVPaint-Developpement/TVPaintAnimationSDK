...
private:
    ...
    nSDK::cTV2ButtonTextString*  mGUICommand  {nullptr};  std::string  mCommand;
    nSDK::cTV2ButtonAction*  mGUIExecute  {nullptr};
    nSDK::cTV2ButtonPopup*  mGUIHistory  {nullptr};
...
void
cTabGeorge::Show( nSDK::cTV2Window*  iWindow, const nSDK::cPixelRectangle&  iArea )
{
    ...
    mTopLabel = new  nSDK::cTV2ButtonLabel( mWindow, id++, {x, y, 80, 20, nSDK::cPixelRectangle::eXYWH::kXYWH}, "Command :"s );  y += 20;

    x = 9;
    y = iArea.Y1() + 25;

    mGUICommand = new  nSDK::cTV2ButtonTextString( mWindow, id++, {x, y, 740, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, ""s, &mCommand, [this](int,const std::string&){ Execute(); } );  x += 750;

    mGUIExecute = new  nSDK::cTV2ButtonAction( mWindow, id++, {x, y, 60, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "Execute"s, [this](int){ Execute(); } );  x += 70;

    mGUIHistory = new  nSDK::cTV2ButtonPopup( mWindow, id++, {x, y, 60, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "History"s, [this](int){ DoHistory(); } );  y += 20;

    mGUIResult = new  nSDK::cTV2ButtonConsoleOut( mWindow, kID_Result, {kTheButtonX, kTheButtonY, kTheButtonW, kTheButtonH, nSDK::cPixelRectangle::eXYWH::kXYWH} );
