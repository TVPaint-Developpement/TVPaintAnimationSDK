...
public:
    void  Show( nSDK2::cTV2Window*  iWindow, int  iY, int  iStartID );
    void  Hide( nSDK2::cTV2Window*  iWindow );

public: // that's OK for demo code, you should use accessor methods in production code...
    nSDK2::cTV2Window*  mWindow  {nullptr};

    nSDK2::cTV2ButtonCheckBox*     mGUIOn         {nullptr};  bool         mOn         {true};
    nSDK2::cTV2ButtonTextInteger*  mGUIID         {nullptr};  int          mID         {0};
    nSDK2::cTV2ButtonTextString*   mGUILabel      {nullptr};  std::string  mLabel      {""s};
    nSDK2::cTV2ButtonCheckBox*     mGUISeparator  {nullptr};  bool         mSeparator  {false};
    nSDK2::cTV2ButtonCheckBox*     mGUIQuiet      {nullptr};  bool         mQuiet      {false};
    nSDK2::cTV2ButtonCheckBox*     mGUICheck      {nullptr};  bool         mCheck      {false};
    nSDK2::cTV2ButtonCheckBox*     mGUIGhost      {nullptr};  bool         mGhost      {false};
    nSDK2::cTV2ButtonCheckBox*     mGUIMulti      {nullptr};  bool         mMulti      {false};
};


void
cLine::Show( nSDK2::cTV2Window*  iWindow, int  iY, int  iStartID )
{
    mWindow = iWindow;

    mGUIOn      = new  nSDK2::cTV2ButtonCheckBox( mWindow, iStartID+kIDOffset_On, {9, iY, 0, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s,     &mOn );
    mGUIOn->HelpText( "Enable/disable this line"s );

    mGUIID = new  nSDK2::cTV2ButtonTextInteger( mWindow, iStartID+kIDOffset_ID, {34, iY,  20, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mID );
    mGUIID->HelpText( "'ID' field"s );

    mGUILabel = new  nSDK2::cTV2ButtonTextString( mWindow, iStartID+kIDOffset_Label, {60, iY, 135, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mLabel );
    mGUILabel->HelpText( "'Name' field"s );

    mGUISeparator  = new  nSDK2::cTV2ButtonCheckBox( mWindow, iStartID+kIDOffset_Separator, {200, iY, 21, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mSeparator );
    mGUISeparator->HelpText( "'Flags' field : bPIPopMode_Separator"s );
    mGUIQuiet      = new  nSDK2::cTV2ButtonCheckBox( mWindow, iStartID+kIDOffset_Quiet, {225, iY, 21, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mQuiet );
    mGUIQuiet->HelpText( "'Flags' field : bPIPopMode_Quiet"s );
    mGUICheck      = new  nSDK2::cTV2ButtonCheckBox( mWindow, iStartID+kIDOffset_Check, {250, iY, 21, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mCheck );
    mGUICheck->HelpText( "'Flags' field : bPIPopMode_Check"s );
    mGUIGhost      = new  nSDK2::cTV2ButtonCheckBox( mWindow, iStartID+kIDOffset_Ghost, {275, iY, 21, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mGhost );
    mGUIGhost->HelpText( "'Flags' field : bPIPopMode_Ghost"s );
    mGUIMulti      = new  nSDK2::cTV2ButtonCheckBox( mWindow, iStartID+kIDOffset_Multi, {300, iY, 21, 0, nSDK2::cPixelRectangle::eXYWH::kXYWH}, ""s, &mMulti );
    mGUIMulti->HelpText( "'Flags' field : bPIPopMode_Multi"s );
}


void
cLine::Hide( nSDK2::cTV2Window*  iWindow )
{
...
private:
    ...
    nSDK2::cTV2ButtonPopup*     mButton       {nullptr};
};
...
void
cTabPopup::Show( nSDK2::cTV2Window*  iWindow, const nSDK2::cPixelRectangle&  iArea )
{
    ...
    mButton      = new  nSDK2::cTV2ButtonPopup( mWindow, id++, {kTheButtonX, kTheButtonY, 150, 20, nSDK2::cPixelRectangle::eXYWH::kXYWH}, "Ga Bu Zo Meu"s, [this]( int  iID ){ DoPopup(); } ); y += 20;
}
