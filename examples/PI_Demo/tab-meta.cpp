...
class  cTabMeta :
    public  nSDK::cTV2Tab,
    public  nSDK::cTV2MetaEventHandlingMixIn
{
public:
...
public:
    virtual  nSDK::tErrorCode  HandleMetaEvent( INTPTR  iEvent, INTPTR*  iArgs )  override;

private:
    cDemoWindow*  mWindow;
    nSDK::cTV2RadioGroup  mMetaFunction;

    nSDK::cTV2ButtonLabel*  mTopLabel  {nullptr};

    nSDK::cTV2ButtonRadio*     mGUIDot              {nullptr};
    nSDK::cTV2ButtonRadio*     mGUIDraw             {nullptr};
    nSDK::cTV2ButtonRadio*     mGUILine             {nullptr};
    nSDK::cTV2ButtonRadio*     mGUIRectangle        {nullptr};
    nSDK::cTV2ButtonRadio*     mGUICircle           {nullptr};
    nSDK::cTV2ButtonRadio*     mGUIEllipse          {nullptr};
    nSDK::cTV2ButtonRadio*     mGUISpline           {nullptr};

    nSDK::cTV2ButtonCheckBox*  mGUIPreview          {nullptr};  bool  mPreview          {false};

    nSDK::cTV2ButtonCheckBox*  mGUIPreviewBrush     {nullptr};  bool  mPreviewBrush     {false};
    nSDK::cTV2ButtonCheckBox*  mGUINoInterpolation  {nullptr};  bool  mNoInterpolation  {false};
    nSDK::cTV2ButtonCheckBox*  mGUIRefreshPreview   {nullptr};  bool  mRefreshPreview   {false};

    nSDK::cTV2ButtonLabel*  mButtonLabel  {nullptr};
    nSDK::cTV2ButtonConsoleOut*  mButton       {nullptr};
};
...
void
cTabMeta::Show( nSDK::cTV2Window*  iWindow, const nSDK::cPixelRectangle&  iArea )
{
    ...
    mTopLabel = new  nSDK::cTV2ButtonLabel( mWindow, id++, {x, y, 340, 20, nSDK::cPixelRectangle::eXYWH::kXYWH}, "ePIMetaFlags"s );  y += 20;

    x = 80;
    y = iArea.Y1() + 25;
    mGUIDot       = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Dot"s,       kPIMeta_Dot,       &mMetaFunction );  y += 20;
    mGUIDraw      = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Draw"s,      kPIMeta_Draw,      &mMetaFunction );  y += 20;
    mGUILine      = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Line"s,      kPIMeta_Line,      &mMetaFunction );  y += 20;
    mGUIRectangle = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Rectangle"s, kPIMeta_Rectangle, &mMetaFunction );  y += 20;
    mGUICircle    = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Circle"s,    kPIMeta_Circle,    &mMetaFunction );  y += 20;
    mGUIEllipse   = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Ellipse"s,   kPIMeta_Ellipse,   &mMetaFunction );  y += 20;
    mGUISpline    = new  nSDK::cTV2ButtonRadio( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Spline"s,    kPIMeta_Spline,    &mMetaFunction );  y += 20;

    y += 10;
    mGUIPreview   = new  nSDK::cTV2ButtonCheckBox( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_Preview"s,   &mPreview );    y += 20;

    x = 280;
    y = iArea.Y1() + 25;
    mGUIPreviewBrush    = new  nSDK::cTV2ButtonCheckBox( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_PreviewBrush"s,    &mPreviewBrush );     y += 20;
    mGUINoInterpolation = new  nSDK::cTV2ButtonCheckBox( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_NoInterpolation"s, &mNoInterpolation );  y += 20;
    mGUIRefreshPreview  = new  nSDK::cTV2ButtonCheckBox( mWindow, id++, {x, y, 100, 0, nSDK::cPixelRectangle::eXYWH::kXYWH}, "*_RefreshPreview"s,  &mRefreshPreview );   y += 20;
    ...
    mButton      = new  nSDK::cTV2ButtonConsoleOut( mWindow, kID_TheButton, {kTheButtonX, kTheButtonY, kTheButtonW, kTheButtonH, nSDK::cPixelRectangle::eXYWH::kXYWH} );
